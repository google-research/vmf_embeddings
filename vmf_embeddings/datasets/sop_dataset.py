...
"""Dataset class for Stanford Online Products (SOP)."""
...
class StanfordOnlineProductsDataset(dataset.Dataset):
  """Dataset class for Stanford Online Products (SOP)."""

  def __init__(self, dataset_path):
    super(StanfordOnlineProductsDataset, self).__init__(dataset_path)
    self.crop_size = 224
    self.scale = (0.16, 1.0)
    self.resize = (256, 256)
  ...
  def _read_file(self, filename):
    ...
    x = [
        os.path.join(self.dataset_path, "Stanford_Online_Products",
